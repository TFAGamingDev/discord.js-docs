...
export declare enum DiscordJSDocsSourceURLs {
...
export type DiscordJSDocsDataTypesStructure = ClassStructure | FunctionStructure | InterfaceStructure | TypedefsStructure;
